...
//       }]
//     },
//     options: {scales: {yAxes: [{ticks: {beginAtZero: true}}], xAxes: [{barPercentage: 0.2}]}}
//   });
// })(jQuery);
(function ($) {
  "use strict";
...
//       }]
//     },
//     options: {legend: {position: 'top'}, scale: {ticks: {beginAtZero: true}}}
//   });
// })(jQuery);
...
(function ($) {
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        data: [45, 25, 20, 10],
        backgroundColor: ["rgba(242, 85, 33, .9)", "rgba(242, 85, 33, .7)", "rgba(242, 85, 33, .5)", "rgba(0,0,0,0.07)"],
        hoverBackgroundColor: ["rgba(242, 85, 33, .9)", "rgba(242, 85, 33, .7)", "rgba(242, 85, 33, .5)", "rgba(0,0,0,0.07)"]
      }],
...
//       scales: {xAxes: [{display: false}], yAxes: [{ticks: {max: 100, stepSize: 10, min: 0}}]}
//     }
//   });
// })(jQuery);
